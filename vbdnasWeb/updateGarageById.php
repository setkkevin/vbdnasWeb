...
<form action="updateGarageById.php" method="POST">
<tr><td>   
Garage Id :<br>
<td/>
...
<input type="text" name="longitude" required="required" class="form-control"value="<?php if(isset($_GET['longitude'])){echo $_GET['longitude'];}?>"><br>
    ...
    Image<br>
    <td/>
    <input type="file" name="image"value="<?php if(isset($_GET['photo'])){echo $_GET['photo'];}?>">
    </td></tr>
    <tr><td>
    <input type="SUBMIT" name="send" value="Update" class="btn btn-success"><br>
    </td></tr>
</table>
</form>
...
$querry="UPDATE `garages` SET `garagename`='$garagename',`telephone`='$garagetelephone',`latitude`='$latitude',`longitude`='$longitude',`photo`='$filename'WHERE id='$id'";
